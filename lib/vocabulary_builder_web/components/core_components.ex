defmodule VocabularyBuilderWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VocabularyBuilderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VocabularyBuilderWeb.Gettext, "errors", msg, opts)
    end
  end
